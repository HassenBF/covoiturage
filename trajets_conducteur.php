...
if ($_SESSION['loginOK'] == true) {
	...
	$retour = mysql_query("SELECT COUNT(*) AS nbre_entrees FROM trajet WHERE ID='$id_cond'");
	$donnees_compt = mysql_fetch_array($retour);	
	$i=$donnees_compt['nbre_entrees'];
	
	$reponse = mysql_query("SELECT * FROM trajet WHERE ID='$id_cond'") or die(mysql_error());
