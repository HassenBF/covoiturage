...
?>
<html>
<div align="center"><strong>Liste des trajet enregistrés sur le site </strong></br> (cliquer sur une rubrique pour changer l'ordre de tri)<br />
</div>
 ...
 <table width="730" border="1" align="center" cellspacing="0">
      ...
      <tr>
        <th width="140"> <div align="center"><a href="trajet.php?ord=1">
		<?php if ($ord==1) {echo ">&nbsp;";} echo"Ville de depart"; if ($ord==1) {echo "&nbsp;<";}?></a></div></th>
		
        <th width="140"><div align="center"><a href="trajet.php?ord=2">
		<?php if ($ord==2) {echo ">&nbsp;";} echo"Ville d'arrivee"; if ($ord==2) {echo "&nbsp;<";}?> </a></div></th>
		
        <th width="140"><div align="center"><a href="trajet.php?ord=3">
		<?php if ($ord==3) {echo ">&nbsp;";} echo"heure de depart"; if ($ord==3) {echo "&nbsp;<";}?> </a></div></th>
		
		<th width="140"><div align="center"><a href="trajet.php?ord=4">
      ...
      <tr>
		...
		$reponse = mysql_query("SELECT * FROM trajet ORDER BY $classer ") or die(mysql_error());
